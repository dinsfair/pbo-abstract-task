...
public class SeranganPlasma : IKemampuan
{
    public void Gunakan(Robot robot)
    {
        ...
        robot.Energi -= damage;
        Console.WriteLine($"{robot.Nama} terkena Serangan Plasma, energi berkurang sebesar {damage}. Energi sekarang: {robot.Energi}");
    }
}
...
public class SimulatorPertarungan
{
    public static void Main(string[] args)
    {
        ...
        while (bosRobot.Energi > 0 && (robot1.Energi > 0 || robot2.Energi > 0))
        {
            ...
            Console.WriteLine("1. Serang Bos Robot");
            Console.WriteLine("2. Gunakan Kemampuan (Serangan Plasma)");
...
//           Perbaikan, SeranganListrik, Serangan Plasma, PertahananSuper
